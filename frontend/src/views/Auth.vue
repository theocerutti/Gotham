<template>
  <div class="container">
    <div v-if="currentAction === 'login'">
      <v-container fluid>
        <v-card height="490px" width="1000px" style="padding: 15px">
          <v-row dense>
            <v-col :cols="6">
              <v-card class="container" width="500px" height="400px">
                <v-card-title>Login</v-card-title>
                <v-card-text>Sign in to your account</v-card-text>
          ...
          <v-row dense>
            <v-col :cols="6">
              <v-card class="container" width="500px" height="500px">
                ...
                <v-btn @click="signUp" style="margin-left: 38%;" color="#64aacf">
                  sign up
                </v-btn>
              </v-card>
            </v-col>
            <v-col :cols="6">
              <v-card width="440px" height="500px" class="container" color="#64aacf">
                ...
                <v-btn @click="currentAction = 'login'" style="margin-left: 31%;" color="#497d98">
                  Sign in now !
                </v-btn>
              </v-card>
            </v-col>
